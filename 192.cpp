...
int main()
{
    string name[] = {"bailey", "max", "charlie", "buddy", "rocky", "jack", "duke", "cooper", "lucky", "oliver", "sam", "muphy", "rocky", "jake", "tucker", "toby", "cody", "bear", "lumi", "lucy", "daisy", "rosie", "sophie", "emma", "lola", "coco", "lily", "molly", "maggie", "ruby", "annie", "Bella",
